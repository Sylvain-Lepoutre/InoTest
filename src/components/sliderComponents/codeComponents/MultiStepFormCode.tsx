...
const MultiStepForm = () => {
  ...
  return (
    <form className="max-w-lg mx-auto bg-white p-4 shadow">
      {step === 1 && (
        <div className="h-full">
          ...
          <input
            ...
            className="border border-gray-300 ring-1 ring-blue-500 p-2 rounded mb-4"
            value={name}
            onChange={(e) => setName(e.target.value)}
            aria-invalid={nameError ? "true" : "false"}
          />
          {nameError && <p className="text-red-500 -mt-2 mb-3 text-xs">{nameError}</p>}
          <div>
            <button
      ...
      {step === 2 && (
        <div className="h-full">
          ...
          />
          {emailError && <p className="text-red-500 -mt-2 mb-3 text-xs">{emailError}</p>}
          <div>
            <button
