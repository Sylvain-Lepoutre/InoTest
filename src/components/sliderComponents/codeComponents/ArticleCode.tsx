export default `export default function LibraryArticle() {
  return (
    <article className="text md:mt-0 px-3 pb-3">
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8 md:mt-[-1em]">
