...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="flex justify-center items-center md:grid md:grid-cols-2 md:grid-rows-2 md:justify-items-start ">
        <div className=" md:ml-[3rem] col-start-1 row-start-1 -top-[5rem] -mt-[3.5rem] relative md:text-7xl text-4xl font-bold flex flex-row items-start lg:text-9xl lg:mt-[7rem] lg:ml-[5rem]">
          <h1 className="title">
            Inotest
