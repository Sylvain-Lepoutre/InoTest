...
export default function Home() {
  return (
    <>
      ...
      <article
        aria-label="about us"
        className="flex flex-col justify-center items-center  mx-2 bg-[#151515] w-[25rem] h-[26rem] p-10 rounded mt-[-7rem] md:block lg:block xl:block md:ml-[35rem] lg:ml-[45rem] xl:mt-[-4.5rem] xl:ml-[56rem]"
      >
