    ...
    <>
      <header>
        ...
        <Stepper
          ...
          styledButtons="px-4 py-2 mx-2 w-[8rem] my-1 rounded buttonClass2"
          styledButtons2="px-4 py-2 w-[8rem] my-1 rounded buttonClass2 absolute bottom-[3.2rem] flex justify-center align-center"
          styledImage="hidden"
        />
      </header>
    </>
